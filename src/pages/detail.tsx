...
export default function SessionDetail() {
  ...
  }, [router.query, sessions, setLastSessionVisited])
  ...
  }, [analytics, navigateToSessionsHomeTab, removeSession, session])
  ...
  const getAccountsFromAddresses = useCallback(
    (addresses: string[]) => {
              ...
              <Row justifyContent="space-between" alignItems="center">
                ...
                >
                  <ImageWithPlaceholder
                    icon={decodeURI(metadata?.icons[0] ?? '')}
                  />
